...
{green}┃{green}{green}{rad}{yellow}{cyan}{yelloww}{yellow}X{white}{green} ┃{purple}CEO {yelloww}: {green}SH31KH S4J18       {green}┃
{green}┃{white}{green}{rad}{yellow}{cyan}{yelloww}{rad}{green}┃{purple}GIT {yelloww}: {cyan}PAPIYA K AMI AKHONO ONEK VLOVASI       {green}┃
{green}┣━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━┻━━━━━━┳━━━━━━━━━━━━━━━━━━┫
{green}┃ {green}TOOL : {yelloww}BD RANDOM {green}{green}┃ {green}WP {yelloww}: {blue}+8801984254741{green}┃  {yelloww}VERSION {green}: {red}{green}┃
{green}╚━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━╝""")
...
def ___uids___():
    ...
    with tred(max_workers=30) as SefatMahadi:
        ...
        print(f'{green}┗━[{rad}+{green}] IF NO RESULT {rad}[{yelloww}ON{green}/{yelloww}OFF{green}] {green}AIRPLAN MODE')
        linex()
        for love in user:
           ids = code+love
           bu = love[:6]
